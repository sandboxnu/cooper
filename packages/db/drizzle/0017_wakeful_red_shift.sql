...
DO $$ BEGIN
 ALTER TABLE "flagged" ADD CONSTRAINT IF NOT EXISTS "flagged_deactivatedByAdminId_user_id_fk" FOREIGN KEY ("deactivatedByAdminId") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "hidden" ADD CONSTRAINT IF NOT EXISTS "hidden_deactivatedByAdminId_user_id_fk" FOREIGN KEY ("deactivatedByAdminId") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
