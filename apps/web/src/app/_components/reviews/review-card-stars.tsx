export function YellowStar({ className }: { className?: string } = {}) {
  return (
    <svg
...
export function GrayStar({ className }: { className?: string } = {}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="19"
...
export function ReviewCardStars({ numStars }: { numStars: number }) {
  const yellowStar = <YellowStar />;
  const grayStar = <GrayStar />;
