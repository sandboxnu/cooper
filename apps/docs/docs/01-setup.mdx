...
AUTH_GOOGLE_ID=''
AUTH_GOOGLE_SECRET=''
AUTH_GOOGLE_ADMIN_ID=''
AUTH_GOOGLE_ADMIN_SECRET= ''
```
...
**Note**: This section is for `AUTH_GOOGLE_ID` and `AUTH_GOOGLE_SECRET`. Ask an admin for `AUTH_GOOGLE_ADMIN_ID` and `AUTH_GOOGLE_ADMIN_SECRET`.
