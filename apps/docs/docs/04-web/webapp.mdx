...
Currently, we do **not** has a user onboarding flow in place. As a result, a user profile is never created. In order to access the review page, you will need to manually create a profile for the user. See [Drizzle Studio](/docs/backend/database#studio) for more information.
:::
